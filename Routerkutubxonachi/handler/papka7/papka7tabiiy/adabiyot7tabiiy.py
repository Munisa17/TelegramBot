...
@router.message(F.text=="📘 Adabiyot-7tabiiy")
async def send_welcome(message: types.Message):
    doc = FSInputFile("handler/resurs/adabiyot7aniq.pdf")
    await message.answer_document(document=doc, caption="""📘 Adabiyot darsligi
