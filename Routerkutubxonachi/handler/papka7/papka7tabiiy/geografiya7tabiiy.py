...
@router.message(F.text=="🌍 Geografiya-7tabiiy")
async def send_welcome(message: types.Message):
    doc = FSInputFile("handler/resurs/geografiya7.pdf")
    await message.answer_document(document=doc, caption="""🌍 Geografiya darsligi
