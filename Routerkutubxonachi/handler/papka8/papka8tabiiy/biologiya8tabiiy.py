...
@router.message(F.text=="🌱 Biologiya-8tabiiy")
async def send_welcome(message: types.Message):
    doc = FSInputFile("handler/resurs/biologiya8tabiiy.pdf")
    await message.answer_document(document=doc, caption="""🌱 Biologiya darsligi
